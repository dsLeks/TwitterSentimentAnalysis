...
enum SentimentSummary {
    case POSITIVE, NEGATIVE, NEUTRAL, NOTAPPLICABLE
}


class OtherResultsVC: UIViewController, ChartViewDelegate {
    ...
    @IBAction func showDetails(_ sender: UIButton) {
        ...
        performSegue(withIdentifier: "OtherDetailsSegue", sender: nil)
    }
